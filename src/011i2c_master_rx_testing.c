...
int main()
{
	...
	while(1)
	{
		...
		I2C_MasterSendData(&I2CHandle,&commandcode,1,SLAVE_ADDR,I2C_SR);

		I2C_MasterReceiveData(&I2CHandle,&len,1,SLAVE_ADDR,I2C_SR);

		commandcode = 0x52;
		I2C_MasterSendData(&I2CHandle,&commandcode,1,SLAVE_ADDR,I2C_SR);

		I2C_MasterReceiveData(&I2CHandle,rcv_buffer,1,SLAVE_ADDR,I2C_NO_SR);
	}
}
